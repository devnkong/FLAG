...
class DeeperGCN(torch.nn.Module):
    ...
    def forward(self, x, node_index, edge_index, edge_attr, perturb=None):
        ...
        h = self.node_features_encoder(node_features) if perturb is None else self.node_features_encoder(node_features) + perturb
